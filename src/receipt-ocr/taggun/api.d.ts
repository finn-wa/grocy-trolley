...
export interface paths {
  "/api/account/v1/feedback": {
    post: operations["postApiAccountV1Feedback"];
  };
  "/api/account/v1/merchantname/add": {
    post: operations["postApiAccountV1MerchantnameAdd"];
  };
  "/api/receipt/v1/match/file": {
    post: operations["postApiReceiptV1MatchFile"];
  };
  "/api/receipt/v1/simple/encoded": {
    post: operations["postApiReceiptV1SimpleEncoded"];
  };
  "/api/receipt/v1/simple/file": {
    post: operations["postApiReceiptV1SimpleFile"];
  };
  "/api/receipt/v1/simple/storage": {
    post: operations["postApiReceiptV1SimpleStorage"];
  };
  "/api/receipt/v1/simple/url": {
    post: operations["postApiReceiptV1SimpleUrl"];
  };
  "/api/receipt/v1/verbose/encoded": {
    post: operations["postApiReceiptV1VerboseEncoded"];
  };
  "/api/receipt/v1/verbose/file": {
    post: operations["postApiReceiptV1VerboseFile"];
  };
  "/api/receipt/v1/verbose/storage": {
    post: operations["postApiReceiptV1VerboseStorage"];
  };
  "/api/receipt/v1/verbose/url": {
    post: operations["postApiReceiptV1VerboseUrl"];
  };
}
...
export interface definitions {
  ...
  receiptResult: {
    totalAmount?: definitions["totalAmount"];
    taxAmount?: definitions["taxAmount"];
    date?: definitions["date1"];
    merchantName?: definitions["merchantName"];
    merchantAddress?: definitions["merchantAddress"];
    merchantCity?: definitions["merchantCity"];
    merchantState?: definitions["merchantCity"];
    merchantCountryCode?: definitions["merchantCountryCode"];
    merchantPostalCode?: definitions["merchantPostalCode"];
    merchantTypes?: definitions["merchantTypes"];
    /**
  ...
  text: {
     ...
     */
    text?: string;
    regions?: definitions["lineAmounts"];
  };
  invoiceNumber: {
    /** @example 123456 */
    data?: string;
  ...
  belgiumVATNumbers: definitions["Model3"][];
  fapiaoInvoiceNumber: {
    /** @example 80227830 */
    data?: string;
    /** @example 80227830 */
  ...
  excludeItems: definitions["Model4"][];
  productName: {
    /** @example 19 crimes */
    text?: string;
  ...
  Model5: {
    productName?: definitions["productName"];
    wineVarietal?: definitions["wineVarietal"];
    quantity?: definitions["quantity"];
    unitPrice?: definitions["unitPrice"];
  };
  wineListItems: definitions["Model5"][];
  quantity1: {
    /** @example qty 2 @ ... */
    text?: string;
    /** @example 2 */
  ...
  data1: {
    quantity?: definitions["quantity1"];
    unitPrice?: definitions["unitPrice1"];
    name?: definitions["name"];
    totalPrice?: definitions["totalPrice"];
  };
  Model6: {
    data?: definitions["data1"];
  ...
  productLineItems: definitions["Model6"][];
  taxAmount2: {
    /** @example 0,83 */
    text?: string;
    /** @example 0.83 */
  ...
  data2: {
    taxAmount?: definitions["taxAmount2"];
    netAmount?: definitions["netAmount"];
    grossAmount?: definitions["grossAmount"];
    taxRate?: definitions["taxRate"];
    taxType?: definitions["taxType"];
  };
  Model7: {
    data?: definitions["data2"];
    /** @example TVA 5,50 15,01 0,83 15,83 */
    text?: string;
    /** @example 20 */
    index?: number;
  ...
  multiTaxLineItems: definitions["Model7"][];
  receiptNumber: {
    /** @example 11/220371 */
    data?: string;
  ...
  data3: {
    ...
    /** @example 950###8N */
    vatNo?: string;
    vies?: definitions["vies"];
  };
  merchantVerification: {
    data?: definitions["data3"];
  ...
  entities: {
    ...
    belgiumVATNumbers?: definitions["belgiumVATNumbers"];
    fapiaoInvoiceNumber?: definitions["fapiaoInvoiceNumber"];
    fapiaoInvoiceCode?: definitions["fapiaoInvoiceCode"];
    fapiaoMerchantTaxId?: definitions["fapiaoMerchantTaxId"];
    qrCodeData?: definitions["qrCodeData"];
    fapiaoInvoice?: definitions["fapiaoInvoice"];
    ABN?: definitions["ABN"];
    excludeItems?: definitions["excludeItems"];
    wineListItems?: definitions["wineListItems"];
    productLineItems?: definitions["productLineItems"];
    multiTaxLineItems?: definitions["multiTaxLineItems"];
    receiptNumber?: definitions["receiptNumber"];
  ...
  receiptVerboseResult: {
    location?: definitions["LocationResult"];
    lineAmounts?: definitions["lineAmounts"];
    amounts?: definitions["lineAmounts"];
    numbers?: definitions["lineAmounts"];
    totalAmount?: definitions["totalAmount1"];
    taxAmount?: definitions["taxAmount1"];
    date?: definitions["date"];
    merchantName?: definitions["merchantName1"];
    merchantAddress?: definitions["merchantAddress1"];
    merchantCity?: definitions["merchantCity1"];
    merchantState?: definitions["merchantState"];
    merchantCountryCode?: definitions["merchantCountryCode1"];
    merchantPostalCode?: definitions["merchantPostalCode1"];
    merchantTypes?: definitions["merchantTypes1"];
    paymentType?: definitions["paymentType"];
    /** @example 0.7216666666666667 */
    confidenceLevel?: number;
    /** @example 24200 */
    elapsed?: number;
    ...
    itemsCount?: definitions["itemsCount"];
    error?: string;
  };
}
...
export interface operations {
  postApiAccountV1Feedback: {
    parameters: {
      ...
      body: {
        body?: definitions["receiptFeedbackAddPayload"];
      };
    };
    responses: {
      /** Success */
  ...
  postApiAccountV1MerchantnameAdd: {
    parameters: {
      ...
      body: {
        body?: definitions["merchantNameAddPayload"];
      };
    };
    responses: {
      /** Success */
  ...
  postApiReceiptV1MatchFile: {
    parameters: {
      ...
      formData: {
        /** file less than 20MB. Accepted file types: PDF, JPG, PNG, GIF */
        file?: unknown;
        ...
        ipAddress?: string;
        /** An array of primary keywords to match */
        primaryKeywords?: string[];
        /** An array of secondary keywords to match (lower confidence level than primaryKeywords) */
        secondaryKeywords?: string[];
        /** An array of stop words that negate the result to be UNLIKELY */
        stopWords?: string[];
    ...
    responses: {
      /** Success */
      200: {
        schema: definitions["receiptMatchResult"];
      };
      /** Bad Request */
      400: {
        schema: definitions["badRequestError"];
  ...
  postApiReceiptV1SimpleEncoded: {
    parameters: {
      ...
      body: {
        body?: definitions["jsonPayload"];
      };
    };
    responses: {
      /** Success */
      200: {
        schema: definitions["receiptResult"];
      };
      /** Bad Request */
      400: {
        schema: definitions["badRequestError"];
  ...
  postApiReceiptV1SimpleStorage: {
    parameters: {
      ...
      body: {
        body?: definitions["storagePayload"];
      };
    };
    responses: {
      /** Success */
  ...
  postApiReceiptV1VerboseEncoded: {
    ...
    responses: {
      /** Success */
      200: {
        schema: definitions["receiptVerboseResult"];
      };
      /** Bad Request */
      400: {
        schema: definitions["badRequestError"];
